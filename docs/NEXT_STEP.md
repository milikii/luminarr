...
- 保持 cleanup 文档快照继续反映“当前 `.env` 已满足四渠道 smoke 环境键、且在 `app.main` 已运行时本地 `18889/wecom/callback` 已可达、剩余缺口只剩 WeCom 真实私聊证据”这条最新真相，避免环境 blocker、进程未启动和真实 smoke blocker 重新混写。
