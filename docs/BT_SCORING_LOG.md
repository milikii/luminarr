...
- 当前主线状态：进行中；2026-04-19 已完成 Phase 1 基线，`.venv/bin/python -m pytest -q tests/test_bt_candidate_scorer.py` 得到通过，当前最小下一步切到 Phase 2 可选规则加载。
...
当前风险：
- 规则仍是内置常量；`bt_scoring_rules.yml` 还没接进来。
