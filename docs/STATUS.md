...
- 本轮主题性收口：
  ...
  - add 链单消费者状态壳已合并回 `app/services/add_to_downloader.py`：pending presence、pending write-through、confirm execution tail、pending persistence、request facade、confirm preparation、confirm availability、confirm approval、confirm context、confirm finalization。
