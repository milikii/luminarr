...
- 当前又从 cleanup backlog 再收掉几小格：命令解析、inspection、inspect 渲染、blocked outcome、删除执行、PT seed guard 与相关日志都已下沉到 support helper；当前 `cleanup_downloaded_source.py` 已降到 `364` 行。
