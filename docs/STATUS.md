...
- **控制层**
  ...
  - Telegram cleanup handler regression coverage baseline（当前已在 Telegram `handle_message` 级回归守住 `cleanup` / `cleanup inspect` 与 `清理` / `清理检查` 的带参路由、bare discoverability 用法提示，以及 cleanup service 未注册时的最小 `服务未就绪，请稍后重试。` 兜底，不让 Telegram cleanup 文本协议退回成只剩英文带参路径）
...
- focused tests: `12 passed, 64 deselected` (`.venv/bin/python -m pytest -q tests/test_telegram_bot.py -k cleanup`)
- focused tests: `47 passed, 91 deselected` (`.venv/bin/python -m pytest -q tests/test_telegram_bot.py tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py -k cleanup`)
- focused tests: `9 passed, 64 deselected` (`.venv/bin/python -m pytest -q tests/test_telegram_bot.py -k cleanup`)
...
- compile check: `passed` (`python3 -m compileall app tests`)
- focused tests: `14 passed, 12 deselected` (`.venv/bin/python -m pytest -q tests/test_feishu_adapter.py -k cleanup`)
- focused tests: `63 passed, 2 skipped` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py`)
- tests: `303 passed, 2 skipped` (`.venv/bin/python -m pytest -q`)
- compile check: `passed` (`python3 -m compileall app tests`)
...
- compile check: `passed` (`python3 -m compileall app tests`)
- focused tests: `11 passed` (`.venv/bin/python -m pytest -q tests/test_personal_wechat_text.py -k cleanup`)
- focused tests: `57 passed, 2 skipped` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py`)
- tests: `297 passed, 2 skipped` (`.venv/bin/python -m pytest -q`)
- compile check: `passed` (`python3 -m compileall app tests`)
- focused tests: `10 passed` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py -k cleanup`)
- focused tests: `55 passed, 2 skipped` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py`)
- tests: `295 passed, 2 skipped` (`.venv/bin/python -m pytest -q`)
- compile check: `passed` (`python3 -m compileall app tests`)
- focused tests: `28 passed, 27 deselected` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py -k cleanup`)
- focused tests: `53 passed, 2 skipped` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py`)
- tests: `293 passed, 2 skipped` (`.venv/bin/python -m pytest -q`)
- compile check: `passed` (`python3 -m compileall app tests`)
- focused tests: `6 passed, 12 deselected` (`.venv/bin/python -m pytest -q tests/test_feishu_adapter.py -k cleanup`)
- focused tests: `10 passed, 14 deselected` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_feishu_adapter.py -k cleanup`)
- focused tests: `4 passed, 2 deselected` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py -k cleanup`)
- focused tests: `18 passed, 2 deselected` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_cleanup_downloaded_source.py -k cleanup`)
- focused tests: `9 passed` (`.venv/bin/python -m pytest -q tests/test_personal_wechat_text.py`)
- focused tests: `14 passed, 27 deselected` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py -k cleanup`)
- focused tests: `2 passed, 14 deselected` (`.venv/bin/python -m pytest -q tests/test_feishu_adapter.py -k "cleanup and webhook_http_request"`)
- focused tests: `2 passed, 10 deselected` (`.venv/bin/python -m pytest -q tests/test_wecom_adapter.py -k "cleanup and callback_http_request"`)
- focused tests: `37 passed, 2 skipped` (`.venv/bin/python -m pytest -q tests/test_private_chat_runtime.py tests/test_personal_wechat_text.py tests/test_feishu_adapter.py tests/test_wecom_adapter.py`)
- tests: `277 passed, 2 skipped` (`.venv/bin/python -m pytest -q`)
- compile check: `passed` (`python3 -m compileall app tests`)
...
- compile check: `passed` (`python3 -m compileall app tests`)
- focused tests: `30 passed, 2 skipped` (`.venv/bin/python -m pytest -q tests/test_feishu_adapter.py tests/test_wecom_adapter.py tests/test_personal_wechat_text.py tests/test_private_chat_runtime.py`)
- tests: `270 passed, 2 skipped` (`.venv/bin/python -m pytest -q`)
- compile check: `passed` (`python3 -m compileall app tests`)
...
- compile check: `passed` (`python3 -m compileall app tests`)
- manual verification:
  - downloader/library cleanup inspect follow-up guidance baseline passed（`.venv/bin/python tmp_tests/verify_cleanup_inspect_follow_up_baseline.py`，脚本随后已删除）
