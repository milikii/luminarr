...
| `docs/PERSISTENCE_CLOSURE_LOG.md` | 当前持久化吞错收口主线的详细闭环、focused tests 和 commit 轨迹 | 当前主线台账 |
...
1. `docs/NEXT_STEP.md`
2. `docs/STATUS.md`
3. `docs/PERSISTENCE_CLOSURE_LOG.md`（需要看当前主线细节时）
4. `docs/CLEANUP_VERIFICATION_WINDOW.md`（需要看 cleanup 已完成证据时）
